...
WebUI.click(findTestObject('US12/Page_Recursos - PMVIZ/input_Utilizadores_typeR'))

WebUI.click(findTestObject('US13/Page_Recursos - PMVIZ/input_Desempenho das Estaes_type'))
...
WebUI.verifyElementPresent(findTestObject('US13/Page_Recursos - PMVIZ/divchart'), 0)

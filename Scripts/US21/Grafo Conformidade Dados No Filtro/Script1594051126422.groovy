...
WebUI.click(findTestObject('Object Repository/US21/Page_PMVIZ - Grafo de Conformidade/a_ProcessoDemo1'))
...
WebUI.verifyElementPresent(findTestObject('Page_PMVIZ - Grafo de Conformidade/select_mouldAmouldBmouldCmouldD'), 0, FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('Page_PMVIZ - Grafo de Conformidade/select_Desenho MoldePreparar MateriaisTaggi_6b1cb5'), 
...
WebUI.verifyElementPresent(findTestObject('Page_PMVIZ - Grafo de Conformidade/select_denverlisboanairobitokyouser1'), 0, 

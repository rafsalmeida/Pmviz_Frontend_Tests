...
WebUI.setText(findTestObject('Object Repository/US19/Page_Login - PMVIZ/input_Username_username'), 'administrator')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/US19/Page_Freq Perf Graph - PMVIZ/h4_Escolha o tipo de grafo'), 
    0)

...
WebUI.click(findTestObject('Object Repository/US19/Page_Grafo Freq e Desem - PMVIZ/button_Escolha um processo'))
...
WebUI.click(findTestObject('Object Repository/US19/Page_Grafo Freq e Desem - PMVIZ/button_ProcessoDemo1'))

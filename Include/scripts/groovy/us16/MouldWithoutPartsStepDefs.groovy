...
class MouldWithoutPartsStepDefs {
	...
	public void i_see_the_mould_does_not_have_parts() {

		WebUI.verifyElementPresent(findTestObject('US16/Page_Tag - PMVIZ/div_Molde no encontrado ou no tem peas associadas'), 0)

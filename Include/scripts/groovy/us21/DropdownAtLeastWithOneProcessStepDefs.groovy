...
class DropdownAtLeastWithOneProcessStepDefs {
	@When("I click on the reference process select")
	public void i_click_on_the_reference_process_select() {
	...
	public void i_see_the_at_least_one_reference_process() {
	    WebUI.click(findTestObject('Object Repository/US21/Page_PMVIZ - Grafo de Conformidade/span_ProcessoDemo1'))

		WebUI.verifyElementPresent(findTestObject('Object Repository/US21/Page_PMVIZ - Grafo de Conformidade/select_Escolha o processo                  _9b71c2'), 

...
class ModCompByOpActMoldStepDefs {
	@When("I select one mold, one activity and one operator on the selects of model to compare")
	public void i_select_on_mold_one_activity_and_one_operator_on_the_selects_of_model_to_compare() {

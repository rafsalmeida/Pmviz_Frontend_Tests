...
class PersonalStatsStepDefs {
	...
	@When("I choose an activity with events")
	public void i_choose_an_activity_with_events() {
	    new Select(WebUiCommonHelper.findWebElement(findTestObject('US15/Page_Minhas Estatsticas - PMVIZ/select_Escolha um'), 
    2)).selectByValue('1')
	}
	
	@Then("I see my performance")
	public void i_see_my_performance() {
